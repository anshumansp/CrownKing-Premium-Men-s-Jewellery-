                    ...
                    <div className="flex items-center justify-between h-16">
                        ...
                        <Link href="/" className="flex items-center">
                            <Image
                                ...
                                className="mr-2"
                            />
                            <span className="text-xl font-bold text-brand-dark-blue">CrownKing</span>
                        </Link>
            ...
            <footer className="bg-brand-dark-blue text-white py-12">
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        <div>
                            ...
                            <p className="text-gray-300">
                                CrownKing is your premium destination for men's jewellery, offering
                                exquisite pieces that define elegance and style.
                            </p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-gray-300">
                                <li>Email: support@crownking.com</li>
                                <li>Phone: +1 (555) 123-4567</li>
                                <li>Address: 123 Jewelry Street, NY</li>
                            </ul>
                        </div>
                        <div>
                    ...
                    <div className="mt-8 pt-8 border-t border-gray-700 text-center text-gray-300">
                        <p>&copy; {new Date().getFullYear()} CrownKing. All rights reserved.</p>
                    </div>
                </div>
            </footer>
        </div>
