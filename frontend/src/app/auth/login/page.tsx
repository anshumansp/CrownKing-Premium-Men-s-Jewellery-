...
const LoginPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(false);
    // On success, redirect user (e.g., using useRouter from 'next/navigation')
  };
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-lg shadow-lg border border-brand-teal/20">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Or{' '}
            <Link href="/auth/register" className="font-medium text-brand-teal hover:text-brand-dark-blue">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-sm">
              <a href="#" className="font-medium text-brand-teal hover:text-brand-dark-blue">
